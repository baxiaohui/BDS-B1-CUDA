...
int main()
{
	...
	FILE* feph1 = NULL;
	//feph1 = fopen("D:\\7MIF_32Msamp_120Sresult_new.txt", "w");
	feph1 = fopen("D:\\JustForTest.bin", "wb");
	typedef std::complex<float> complexf;
	int generated_samples = 0;//一共产生了多少采样点
	int samp_freq = 20e6;//16.368e6*2;//采样率16.368  49104000
	int simu_time = 10; //调用一次bds_sim函数，产生多久的信号（单位0.1s）
	int time_all = 100;//总仿真时间（单位0.1s）
